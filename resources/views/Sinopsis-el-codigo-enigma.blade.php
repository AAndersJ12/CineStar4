...
<head>
    ...
    <title>Sinopsis El codigo enigma</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/El-codigo-enigma-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>El codigo enigma</h2>
                    <h4>Sinopsis</h4>
                        <p>Biopic sobre el matemático británico Alan Turing, famoso por haber descifrado los códigos secretos nazis contenidos en la máquina Enigma. Su invento determinó el devenir de la Segunda Guerra Mundial (1939-1945) en favor de los Aliados. Lejos de ser admirado como un héroe, Turing fue acusado y juzgado por su condición de homosexual en 1952.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 28 de septiembre de 2014 (Brasil)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/The-imitation-game-(Descifrano-Enigma)-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
