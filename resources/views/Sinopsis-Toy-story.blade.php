...
<head>
    ...
    <title>Sinopsis Toy Story</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Toy-story-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Toy Story</h2>
                    <h4>Sinopsis</h4>
                        <p>Los juguetes de Andy, un niño de seis años, temen que un nuevo regalo les sustituya en el corazón de su dueño. Woody, un vaquero que ha sido hasta ahora el juguete favorito, trata de tranquilizarlos hasta que aparece Buzz Lightyear. Lo peor es que el arrogante Buzz se cree que es una auténtico astronauta en plena misión para regresar a su planeta.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 3 de enero de 1996 (Venezuela)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Toy-Story-trailer-latino.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
