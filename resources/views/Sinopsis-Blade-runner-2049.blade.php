...
<head>
    ...
    <title>Sinopsis Blade runner 2049</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/blade-runner-2049-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Blade runner 2049</h2>
                    <h4>Sinopsis</h4>
                        <p>Tras la rebelión de los replicantes creados por bioingeniería para ser utilizados como mano de obra esclava y la prohibición a Tyrell Corporation de seguir con su fabricación, el empresario Niander Wallace adquirió lo que quedaba de Tyrell Corp. y creó una nueva línea de replicantes mucho más obedientes. Ahora, en el año 2049, los viejos modelos Nexus 8 que continúan con vida están siendo retirados. Los que les persiguen aún reciben el nombre de Blade Runner.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 5 de octubre de 2017 (Reino Unido) Director: Denis Villeneuve</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/BLADE-RUNNER-2049-Trailer.mp4" type="video/mp4">
                    </video>  
            </div>
        </section>
    </main>
