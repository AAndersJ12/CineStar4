    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="sobrenosotros-habilidades-A">Habilidades <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="sobrenosotros-habilidades-D" class="nav-link"><i class="fa-regular fa-user">Diego Flores</i></a>
                </li>
                </ul>
            </div>
            </nav>
