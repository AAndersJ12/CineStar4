    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="sobrenosotros-habilidades-A.html">Habilidades <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="sobrenosotros-habilidades-D.html" class="nav-link"><i class="fa-regular fa-user">Diego Flores</i></a>
                </li>
                </ul>
            </div>
            </nav>
        <div class="CartasSobrenosotros">  
            ...
            <p class="texto"><strong>Liderazgo</strong></p>
            <p class="texto"><strong>Trabajo en equipo</strong></p>
            <p class="texto"><strong>Comunicacion escrita</strong></p>
            <p class="texto"><strong>Resolucion de problemas</strong></p>
            <p class="texto"><strong>Etica de trabajo</strong></p>
            </div>
        </section>
        </main> 
        </div>
