...
<head>
    ...
    <title>Sinopsis El conjuro 3</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/El-conjuro-3-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>El conjuro 3</h2>
                    <h4>Sinopsis</h4>
                        <p>Los investigadores de fenómenos paranormales Ed y Lorraine Warren se enfrentan a un nuevo caso: el de un hombre acusado de un terrible asesinato, que asegura haber sido poseído por un demonio.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 26 de mayo de 2021 (Reino Unido)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/EL-CONJURO-3-Tráiler.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>  
