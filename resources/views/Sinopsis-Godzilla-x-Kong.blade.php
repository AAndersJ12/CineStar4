...
<head>
    ...
    <title>Sinopsis Godzilla x Kong</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Godzilla-x-Kong-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Godzilla x Kong: El nuevo imperio</h2>
                    <h4>Sinopsis</h4>
                        <p>Godzilla y Kong se enfrentan a una amenaza colosal escondida en lo profundo del planeta, desafiando su propia existencia y la supervivencia de la raza humana.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 29 de marzo de 2024 (Estados Unidos) Director: Adam Wingard</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Godzilla-x-kong-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>  
