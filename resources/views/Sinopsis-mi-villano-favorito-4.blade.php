...
<head>
    ...
    <title>Sinopsis Mi villano favorito 4</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="Sinopsis-mi-villano-favorito-4.html" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Mi villano favorito 4</h2>
                    <h4>Sinopsis</h4>
                        <p>Despicable Me 4 es una película de comedia animada estadounidense producida por Illumination y distribuida por Universal Pictures. Servirá como secuela de Despicable Me 3, la cuarta entrega principal y la sexta entrega en general de la franquicia.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 3 de julio de 2024 (Estados Unidos) Directores: Chris Renaud, Patrick Delage</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Mi- villano-favorito-4-Trailer.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>
