...
<head>
    ...
    <title>Sinopsis ready player one</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Ready-player-one-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Ready player one</h2>
                    <h4>Sinopsis</h4>
                        <p>Año 2045: el adolescente Wade Watts es solo una de las millones de personas que se evaden del sombrío mundo real para sumergirse en un mundo utópico virtual donde todo es posible: OASIS. Wade participa en la búsqueda del tesoro que el creador de este mundo imaginario dejó oculto en su obra. No obstante, hay gente muy peligrosa compitiendo contra él.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 29 de marzo de 2018 (Estados Unidos) Director: Steven Spielberg</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/READY-PLAYER-ONE-Trailer-Oficial-Warner-Bros.mp4" type="video/mp4">
                    </video>  
            </div>
        </section>
    </main>  
