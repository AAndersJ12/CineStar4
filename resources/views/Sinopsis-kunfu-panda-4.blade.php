...
<head>
    ...
    <title>Sinopsis Kunfu panda 4</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Kunfu-panda-4-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Kunfu panda 4</h2>
                    <h4>Sinopsis</h4>
                        <p>Po está entrenando a un nuevo guerrero que ocupe su lugar para que él pueda convertirse en líder espiritual del Valle de la Paz. Sin embargo, la irrupción de una malvada hechicera que puede cambiar de apariencia trastoca sus planes.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 8 de marzo de 2024 (Estados Unidos) Director: Mike Mitchell</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Kunfu-panda-4-Trailer.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>  
