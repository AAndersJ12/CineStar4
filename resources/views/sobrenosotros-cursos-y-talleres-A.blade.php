...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="sobrenosotros-cursos-y-talleres-A.html">Cursos y Talleres</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="sobrenosotros-cursos-y-talleres-D.html" class="nav-link"><i class="fa-regular fa-user">Diego Flores</i></a>
            </li>
            </ul>
        </div>
        </nav>
        <div class="CartasSobrenosotros">  
            ...
            <p class="texto"><strong>Curso de Conferencista Internacional: </strong>Motivando tu Éxito</p>
            <p class="texto"><strong>Curso de Reparación de Celulares: </strong>IUJO CEP</p>
            <p class="texto"><strong>Curso de Python básico: </strong>IUJO CEP</p>
            </div>
            <div class="col"> 
            <h4 class="titulos-sobrenosotros">Talleres</h4>
                <p class="texto"><strong>Taller de Salsa: </strong>IUJO Catia</p>
                <p class="texto"><strong>Taller de Inteligencia Artificial: </strong>ELAM</p>
            </div> 
        </section>
        </main> 
        </div>
