...
<head>
    ...
    <title>Sinopsis Spiderman 3</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Spiderman-3-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Spiderman 3</h2>
                    <h4>Sinopsis</h4>
                        <p>Peter Parker sufre una terrible transformación cuando su traje se vuelve negro y libera su personalidad oscura y vengativa. Afrontará el mayor desafío de su vida al tener que redescubrir la humildad y compasión que lo hacen ser quien es: un héroe.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 4 de mayo de 2007 (Venezuela)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Spider-Man-3-(2007)-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>  
