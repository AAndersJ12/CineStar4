...
<head>
    ...
    <title>Sinopsis Deadpool 3</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Deadpool-3-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Deadpool 3</h2>
                    <h4>Sinopsis</h4>
                        <p>Lobezno se recupera de sus heridas cuando se cruza con el bocazas, Deadpool, que ha viajado en el tiempo para curarlo con la esperanza de hacerse amigos y formar un equipo para acabar con un enemigo común.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 26 de julio de 2024 (Estados Unidos)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Deadpool-3-Deadpool-y-Wolverine-Trailer.mp4" type="video/mp4">
                    </video> 
            </div>
        </section>
    </main>
