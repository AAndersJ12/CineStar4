...
<head>
    ...
    <title>Sinopsis Toy Story 2</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Toy-story-2-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Toy Story 2</h2>
                    <h4>Sinopsis</h4>
                        <p>Cuando Andy se va de campamento dejando solos a los juguetes, Al McWhiggin, un compulsivo coleccionista de juguetes valiosos, secuestra a Woody. Buzz Lightyear y los demás juguetes tendrán que actuar con rapidez si quieren rescatarlo. Durante la operación de rescate no sólo tendrán que afrontar múltiples peligros, sino que también vivirán divertidas situaciones.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 24 de noviembre de 1999 (Estados Unidos)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Toy-Story-2-(1999)-Trailer.mp4" type="video/mp4">
                    </video>     
            </div>
        </section>
    </main>
