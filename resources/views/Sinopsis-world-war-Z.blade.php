...
<head>
    ...
    <title>Sinopsis world war z</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/world-war-z-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>World war z</h2>
                    <h4>Sinopsis</h4>
                        <p>Cuando una pandemia de zombis amenaza con destruir a la humanidad, un ex-investigador de Naciones Unidas es obligado a regresar al servicio para intentar descubrir la fuente de la infección.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 16 de agosto de 2013 (Venezuela) Director: Marc Forster</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Guerra-Mundial-Z-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
