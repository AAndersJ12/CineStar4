...
<head>
    ...
    <title>Sinopsis El conjuro 2</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/El-conjuro-2-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>El conjuro 2</h2>
                    <h4>Sinopsis</h4>
                        <p>Ed y Lorraine Warren, renombrados demonólogos e investigadores de lo paranormal, se enfrentan de nuevo a las fuerzas infernales. En esta ocasión, viajan hasta el norte de Londres para tratar de ayudar a una madre y sus cuatro hijos, quienes habitan en una casa plagada de espíritus malignos.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 10 de junio de 2016 (Estados Unidos)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/EL-CONJURO-2-Trailer.mp4" type="video/mp4">
                    </video>     
            </div>
        </section>
    </main>  
