...
<head>
    ...
    <title>Sinopsis Spiderman 2</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Spiderman-2-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Spiderman 2</h2>
                    <h4>Sinopsis</h4>
                        <p>Como si Peter Parker no tuviera suficiente con sus propios problemas, estudios y su amor por Mary Jane, ahora tiene que salvar a la ciudad de un nuevo villano, el Doctor Octopus.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 14 de julio de 2004 (Venezuela)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Spider-Man-2-Tráiler.mp4" type="video/mp4">
                    </video>  
            </div>
        </section>
    </main>  
