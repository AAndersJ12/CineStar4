...
<head>
    ...
    <title>Sinopsis Deadpool 2</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Deadpool-2-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Deadpool 2</h2>
                    <h4>Sinopsis</h4>
                        <p>Deadpool trabaja ahora a escala internacional, eliminando a asesinos de masas, gánsteres, traficantes de personas y demás indeseables. Se creen intocables, pero Deadpool sabe cómo deshacerse de ellos de la forma más complicada, desmedida y sangrienta posible.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 15 de mayo de 2018 (Reino Unido)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Deadpool-2-Trailer.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>  
