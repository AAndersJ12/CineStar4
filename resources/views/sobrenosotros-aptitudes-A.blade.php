    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="sobrenosotros-aptitudes-A.html">Aptitudes</a>
                </li>
                <li class="nav-item">
                    <a href="sobrenosotros-aptitudes-D.html" class="nav-link"><i class="fa-regular fa-user">Diego Flores</i></a>
                </li>
                </ul>
            </div>
            </nav>
        <div class="CartasSobrenosotros">  
            ...
            <h4 class="titulos-sobrenosotros">Aptitudes</h4>
                <ul class="texto">
                    ...
                    <li>Conocimiento en ofimática</li>
                    <li>Redes compartidas</li>
                    <li>HTML(intermedio), CSS(intermedio) y JS(básico)</li>
                    <li>Python(básico)</li>
                    <li>Comunicación efectiva</li>
                    <li>Conocimientos en Bootstrap5</li>
                    <li>Proactivo</li>
                </ul>
            </div>
        </section>
