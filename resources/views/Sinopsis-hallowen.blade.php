    ...
    <main>
        ...
        <section class="Sinopsis">
            <div class="titulo-cartelera">
                <img src="./assets/media/billboards/Hallowen-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Hallowen</h2>
                    ...
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 25 de octubre de 1978 (Estados Unidos) Director: John Carpenter</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Halloween-Official-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
