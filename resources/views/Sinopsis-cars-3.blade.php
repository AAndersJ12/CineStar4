...
<head>
    ...
    <main>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Cars-3-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Cars 3</h2>
                    ...
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 16 de junio de 2017 (Estados Unidos)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Cars-3-(2017)-Tráiler.mp4" type="video/mp4">
                    </video>     
            </div>
        </section>
    </main>  
