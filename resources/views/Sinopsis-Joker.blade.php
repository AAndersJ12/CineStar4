...
<head>
    ...
    <main>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Joker-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Joker</h2>
                    ...
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 3 de octubre de 2019 (Australia) Director: Todd Phillips</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/JOKER-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>  
