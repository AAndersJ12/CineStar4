    ...
    <header>
        ...
        <div class="CartasSobrenosotros">  
            ...
            <h4 class="titulos-sobrenosotros">Anderson Abreu</h4>
                <img src="./assets/media/img/Foto-Curriculo.jpeg" class="img-info-others" alt="" srcset="">

            </div>
            <div class="col"> 
            <h4 class="titulos-sobrenosotros">Experiencia laboral</h4>
            <p class="texto"><strong>Puesto: </strong>Analista de Redes</p>
            <p class="texto"><strong>Herramientas de trabajo y destrezas empleadas: </strong>Linux Bash, cableado estructurado, Linux, virtualización Proxmox, Zabbix, OCS + GLPI, Carpetas compartidas</p>
            <p class="texto"><strong>Experiencia adquirida: </strong>Experiencia basica en infraestructura de red y Esperiencia intermedia en cableado de red de cobre</p>
            <br>
            <p class="texto"><strong>Puesto: </strong>Analista de Recursos Humanos</p>
            <p class="texto"><strong>Herramientas de trabajo y destrezas empleadas: </strong>ofimática en Windows, ofimática en Linux, Macros de Excel, Sistema de Gestion Pública</p>
            <p class="texto"><strong>Experiencia adquirida: </strong> Experiencia en leyes del trabajador, beneficio de vacaciones, formulas de excel, control y redacción de memos, trabajo en conjunto con otras areas de trabajo, impuestos legales, teoría básica de contabilidad y teoría básica de presupuesto</p>
            </div>
        </section>
        </main> 
        </div>
