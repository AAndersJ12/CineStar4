...
<head>
    ...
    <title>Sinopsis Toy Story 4</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Toy-story-4-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Toy Story 4</h2>
                    <h4>Sinopsis</h4>
                        <p>Woody siempre ha tenido claro cuál es su labor en el mundo y cuál es su prioridad: cuidar a su dueño, ya sea Andy o Bonnie. Sin embargo, Woody descubrirá lo grande que puede ser el mundo para un juguete cuando Forky se convierta en su nuevo compañero de habitación. Los juguetes se embarcarán en una aventura de la que no se olvidarán jamás</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 21 de junio de 2019 (Estados Unidos)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Toy-Story-4-(2019)-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
