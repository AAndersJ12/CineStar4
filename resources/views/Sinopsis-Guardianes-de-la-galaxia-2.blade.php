...
<head>
    ...
    <title>Sinopsis Guardianes de la galaxia 2</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Guardianes-de-la-galaxia-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Guardianes de la galaxia 2</h2>
                    <h4>Sinopsis</h4>
                        <p>Una poderosa raza alienígena contrata a los Guardianes para que protejan sus valiosas baterías de energía, pero, cuando Rocket las roba, los alienígenas envían a sus tropas de combate a vengarse de los Guardianes. Mientras tratan de escapar con vida, intentan resolver el misterio de los verdaderos orígenes de Peter Quill.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 5 de mayo de 2017 (Estados Unidos) Director: James Gunn</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Guardianes-de-la-Galaxia-Vol.2-Nuevo-Trailer.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>  
