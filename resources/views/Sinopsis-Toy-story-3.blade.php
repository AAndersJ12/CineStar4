...
<head>
    ...
    <title>Sinopsis Toy Story 3</title>
</head>
    <body>
    <main>
        <header>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Toy-story-3-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Toy Story 3</h2>
                    <h4>Sinopsis</h4>
                        <p>Cuando su dueño Andy se prepara para ir a la universidad, el vaquero Woody, el astronauta Buzz y el resto de sus amigos juguetes comienzan a preocuparse por su incierto futuro. Todos acaban en una guardería donde comenzarán una serie de trepidantes y divertidas aventuras.</p>
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 18 de junio de 2010 (Venezuela)</p>
                    <h4>Trailer</h4>
                    <video controls>
                        <source src="./assets/media/trailers/Toy-Story-3-Trailer.mp4" type="video/mp4">
                    </video>    
            </div>
        </section>
    </main>
