...
<head>
    ...
    <main>
        ...
        <section class="Sinopsis">
            <div>
                <img src="./assets/media/billboards/Cars-cartelera.jpg" alt="" srcset="" class="sinopsis-img">
            </div>
            <div class="Sinopsis-Datos">
                <h2>Cars</h2>
                    ...
                    <h4>Datos</h4>
                        <p>Fecha de estreno: 30 de junio de 2006 (Brasil)</p>
                    <h4>Trailer</h4>
                <video controls>
                        <source src="./assets/media/trailers/Cars-Trailer-Oficial.mp4" type="video/mp4">
                    </video>   
            </div>
        </section>
    </main>
